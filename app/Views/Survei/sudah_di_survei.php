                    ...
                    <tbody>
                        ...
                        foreach ($survei as $row) : ?>
                            ...
                            <tr>
                                ...
                                <td><?= $row['nama_desa']; ?></td>
                                <td><?= $row['alamat']; ?></td>
                                <td><?= date('d-m-Y', strtotime($row['tanggal_survei'])); ?></td>
                                ...
                                <td>
                                    <div class="btn-group" role="group" aria-label="Action Buttons">
                                        ...
                                        <!-- Tombol Print -->
                                        <form action="<?= base_url('Survei/print/' . $row['id_survei']); ?>" method="get" target="_blank">
                                            <button type="submit" class="btn btn-sm btn-info"><i class="fas fa-print"></i></button>
                                        </form>
